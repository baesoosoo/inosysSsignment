...
<script type="text/javascript">
 ...
 $(document).ready(function() {
	 ...
	 $(".commentDelete").on("click",function(){
		 ...
		 var deleteNum =$(this).data("id");
		 
		 $.ajax({
			url:"/mavenBoard/commentDelete.ino",
			type:"POST",
			data:{
				num:deleteNum
			},
			...
			error:function(e){
				alert("댓글 삭제를 실패하였습니다"+e.responseText);
			}
		 });
...
<body>
	...
	<div id="commentCon">
	    ...
	    <div id="commentCon${comment.num}">
	       <span class="commentWriter"><strong>${comment.writer} </strong></span><span class="commentModifyCon">${comment.content} </span>
	      <span><a href="#" class="commentModify"  data-id="${comment.num} ">수정</a></span>
	      <span><a href="#" class="commentDelete"  data-id="${comment.num} ">삭제</a></span>
